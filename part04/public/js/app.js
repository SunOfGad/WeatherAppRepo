...
let cityState = document.querySelector('#message1');
...
weatherForm.addEventListener('submit', (e) => {
	...
	response.json().then((data) => {
		...
		{
			message1.textContent = "Current Weather Conditons for : ";
			...
			message3.textContent = "Feels Like Temp: ";
			feelsLikeTemp.textContent = data.weather.currentTemp + " F" ;
